...
public class SerieFormActivity extends AppCompatActivity {
    private Serie serie;
    ...
    private void registrarEventos() {
        ...
        btnFormSerieDeletar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (serie.getId() != null) {
                    new AlertDialog.Builder(SerieFormActivity.this)
                            .setTitle("Sair")
    ...
    private void gravarDados (Integer requestMethod) {
        final String dadosJson = gson.toJson(serie);
    ...
    private void excluirRegistro () {
        ...
        StringRequest request = new StringRequest(Request.Method.DELETE, url, new Response.Listener<String>() {
            ...
            if (error.networkResponse.statusCode == 404) {
                Toast.makeText(SerieFormActivity.this,"O registro não foi encontrado.\nPor favor, atualize a lista.", Toast.LENGTH_LONG).show();
            }
            }
        });
        requestQueue.add(request);
